...
const { client: contacts } = usePrismic();

contacts.getByUID("page", "contacts").then((document) => {
  ...
  >
    <div data-aos="fade-up">
      <PrismicRichText
        ...
        class="text-center text-4xl md:text-5xl font-semibold pb-10"
      />
      ...
      <div class="text-center sm:text-left pb-5">
        <PrismicText
          ...
          class="text-2xl font-semibold"
        />
        <PrismicText :field="slice.primary.phone_item" class="text-lg" />
      </div>
      <div class="text-center sm:text-left pb-5">
        <PrismicText
